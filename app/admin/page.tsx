...
export default async function AdminDashboard() {
  ...
  const stats = [
    ...
    { label: "Teams", value: teamCount, href: "/admin/teams", urgent: false },
    ...
    <div>
      ...
      {!board && (
        <div className="bg-[#0e0820] border border-dashed border-purple-900/50 rounded-xl p-6 text-center">
          ...
          <Link href="/admin/board" className="text-purple-400 hover:text-purple-300 text-sm font-medium transition-colors">
            Create one →
          </Link>
        </div>
      )}
